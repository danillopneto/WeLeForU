...
public class FingerprintHandler extends FingerprintManager.AuthenticationCallback {
    ...
    public void onAuthenticationFailed() {
        Toast.makeText(context, App.getLocalMessage(R.string.auth_failed), Toast.LENGTH_LONG).show();
    }
    ...
    public void onAuthenticationSucceeded(
        ...
        WebTaskLogin taskLogin = new WebTaskLogin(context, "Logado pela digital", "1234");
        taskLogin.execute();
    }
}